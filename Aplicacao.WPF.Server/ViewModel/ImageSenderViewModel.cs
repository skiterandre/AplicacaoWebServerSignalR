using Aplicacao.WPF.Server.Commands;
...
namespace Aplicacao.WPF.Server.ViewModel
{
    public class ImageSenderViewModel: ViewModelBase
    {
        ...
        public ImageSenderViewModel(IHubContext signalRImageSenderService)
        {
        ...
        public static ImageSenderViewModel CreatedConnectedViewModel(IHubContext chatService)
        {
